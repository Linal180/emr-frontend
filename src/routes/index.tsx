...
import VitalsCards from "../components/main/patients/patientsDetails/patientChart/patientChartCards/vitalsCard";
...
import {
  ...
  PATIENT_APPOINTMENT_CANCEL, PATIENTS_CHART, VITALS_ROUTE, PRACTICE_MANAGEMENT_ROUTE
} from "../constants";
