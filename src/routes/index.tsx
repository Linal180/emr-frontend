...
import { ADD_LAB_ORDERS_RESULTS_ROUTE, AGREEMENTS_ROUTE, APPOINTMENTS_ROUTE, APPOINTMENT_PAYMENT, AUTO_LOGOUT_ROUTE, CALENDAR_ROUTE, CANCELLATION_ROUTE, CANCEL_APPOINTMENT, CHANGE_PASSWORD_ROUTE, CHART_ROUTE, CHECK_IN_ROUTE, CLAIMS_ROUTE, CREATE_LAB_ORDERS_ROUTE, DASHBOARD_ROUTE, DOCTORS_ROUTE, EDIT_LAB_ORDERS_ROUTE, EMERGENCY_ACCESS_ROUTE, FACILITIES_ROUTE, FACILITY_PUBLIC_APPOINTMENT_ROUTE, FACILITY_SERVICES_ROUTE, FORGET_PASSWORD_ROUTE, FORM_BUILDER_COPY_TEMPLATE_ROUTE, FORM_BUILDER_EDIT_ROUTE, FORM_BUILDER_RESPONSES, FORM_BUILDER_ROUTE, INVOICES_ROUTE, LAB_RESULTS_ROUTE, LOCK_ROUTE, LOGIN_ROUTE, MAINTENANCE_ROUTE, PATIENTS_ROUTE, PATIENT_APPOINTMENT_CANCEL, PATIENT_APPOINTMENT_FAIL, PATIENT_APPOINTMENT_SUCCESS, PATIENT_INFORMATION_ROUTE, PRACTICE_DETAILS_ROUTE, PRACTICE_MANAGEMENT_ROUTE, PROFILE_ROUTE, PROVIDER_PUBLIC_APPOINTMENT_ROUTE, PUBLIC_FORM_BUILDER_FAIL_ROUTE, PUBLIC_FORM_BUILDER_ROUTE, PUBLIC_FORM_BUILDER_SUCCESS_ROUTE, RESET_PASSWORD_ROUTE, ROLES_ROUTE, ROOT_ROUTE, SETTINGS_ROUTE, SET_PASSWORD_ROUTE, SIGNATURE_ROUTE, SLOT_CONFIRMATION, STAFF_ROUTE, TWO_FA_AUTHENTICATION_ROUTE, TWO_FA_ROUTE, USER_PERMISSIONS, VIEW_APPOINTMENTS_ROUTE, VITALS_ROUTE } from "../constants";
