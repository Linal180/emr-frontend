...
import {
  ...
  INVOICES_ROUTE, LAB_RESULTS_ROUTE, LOCK_ROUTE, LOGIN_ROUTE, MAINTENANCE_ROUTE, PATIENTS_ROUTE,
  PATIENT_APPOINTMENT_CANCEL, PATIENT_APPOINTMENT_FAIL, PATIENT_APPOINTMENT_SUCCESS, PATIENT_INFORMATION_ROUTE,
  ...
  SUPER_BILL_ROUTE, TWO_FA_AUTHENTICATION_ROUTE, TWO_FA_ROUTE, USER_PERMISSIONS, VIEW_APPOINTMENTS_ROUTE
} from "../constants";
