import { FindAllCvxPayload } from "../generated/graphql";
...
export type Action =
  ...
  { type: ActionType.SET_DATA; data: FindAllCvxPayload['cvxs'] }

export const cvxCodeReducer = (state: State, action: Action): State => {
  switch (action.type) {
