import { FindAllImagingTestPayload } from "../generated/graphql";
...
export interface State {
  ...
  searchQuery: string;
  systematic: boolean;
  data: FindAllImagingTestPayload['imagingTests']
}
...
export type Action =
  ...
  { type: ActionType.SET_DATA; data: FindAllImagingTestPayload['imagingTests'] }

export const imagingTestReducer = (state: State, action: Action): State => {
  switch (action.type) {
