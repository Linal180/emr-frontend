import { FindAllMvxPayload } from "../generated/graphql";
...
export type Action =
  ...
  { type: ActionType.SET_DATA; data: FindAllMvxPayload['mvxs'] }

export const mvxCodeReducer = (state: State, action: Action): State => {
  switch (action.type) {
