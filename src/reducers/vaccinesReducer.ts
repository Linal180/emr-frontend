import { VaccineProduct, FindAllVaccinesPayload } from "../generated/graphql";
...
export type Action =
  ...
  { type: ActionType.SET_SEARCHED_DATA, searchedData: VaccineProduct[] }
