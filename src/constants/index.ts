...
export const ACCEPTABLE_ONLY_IMAGES_FILES = [".jpg", ".jpeg", ".png",];
export const ACCEPTABLE_PDF_AND_IMAGES_FILES = [".jpg", ".jpeg", ".png",".pdf",];
export const ACCEPTABLE_FILES = [".jpg", ".jpeg", ".png", ".docx", ".doc", ".pdf", ".mp3",];
