...
import {
  CLAIMS_REQUIRING_ACTION, CLAIM_AMOUNT_TO_PROCESS, CLAIM_IN_PROCESS, CLAIM_RECEIVED, MEDICAL_BILLING, TOTAL_CLAIM_TEXT,
} from "../../../constants";
import { RedirectIcon, PracticeActiveIcon, PracticeInactiveIcon, ClaimActionIcon, ClaimAmountIcon } from "../../../assets/svgs";
