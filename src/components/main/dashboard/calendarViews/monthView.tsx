...
export const MonthTimeTableCell = (props: MonthView.TimeTableCellProps) => {
  ...
  const previousCells = new Date() > new Date(endDate || '')

  return <MonthView.TimeTableCell {...props} onDoubleClick={() => { handleViewDate(props) }} isShaded={previousCells ? true : false} />;
};
