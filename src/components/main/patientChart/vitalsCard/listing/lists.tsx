...
import { fahrenheitToCelsius, formatValue, getFormattedDateTime, inchesToCentimeter, kilogramToOunce, kilogramToPounds, renderTh, roundOffUpto2Decimal } from '../../../../../utils';
            ...
            <TableHead>
              <TableRow>
                {patientVitals?.map((vital) => {
                  ...
                  return renderTh(getFormattedDateTime(createdAt || ''), 'left', false, '', true, () => renderIcon(vital))
                })}
              </TableRow>
            </TableHead>
