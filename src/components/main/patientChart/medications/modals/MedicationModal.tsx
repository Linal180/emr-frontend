...
import {
  ACTIVE, ADD, ADD_MEDICATION, CANCEL, NOTES, ORAL_ROUTE_OPTIONS, PATIENT_PROBLEM_ADDED, PATIENT_PROBLEM_UPDATED, SIG, START_DATE, STATUS, STOP_DATE, STOP_REASON, STOP_REASON_OPTIONS, STRUCTURED, TABLET_UNIT_OPTIONS, TAKE, TIME_DURATION_OPTIONS, UPDATE, UPDATE_MEDICATION
} from '../../../../../constants';
import {
