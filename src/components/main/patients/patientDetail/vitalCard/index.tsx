...
import {
  BLOOD_PRESSURE_TEXT, BLOOD_PRESSURE_UNIT, HEART_RATE_TEXT, HEART_RATE_UNIT, LAST_READING_TEXT, N_A, SLASH_IN_DASHES
} from "../../../../../constants";
        ...
        <Grid item lg={6} md={12} sm={12} xs={12}>
          <Box width="100%" className='card-chart'>
            ...
            <Box className='bloodPressure-measurement'>
              <Typography variant="h2">{systolicBloodPressure ? `${systolicBloodPressure} / ${diastolicBloodPressure}` : SLASH_IN_DASHES}
