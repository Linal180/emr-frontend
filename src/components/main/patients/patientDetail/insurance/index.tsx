...
import {
  ADD_INSURANCE, ADD_INSURANCE_INFORMATION, CHECK_ELIGIBILITY_TODAY, COPAY_TEXT, COVERAGE_ROUTE,
  ELIGIBILITY_ERROR_MESSAGE, ELIGIBILITY_TEXT, ID_TEXT, MAPPED_POLICY_ORDER_OF_BENEFIT, EFFECTIVE_TEXT,
