...
import {
  ABNORMAL_FLAG, ADD_ANOTHER_SPECIMEN, APPOINTMENT_TEXT, COLLECTION_DATE, COLLECTION_TIME, CREATE_LAB_ORDER, DELETE, DESCRIPTION, DOCTOR_SIGNOFF, EDIT_LAB_ORDER, EMPTY_OPTION, NORMAL_RANGE,
  NORMAL_RANGE_UNITS, RESULT_UNITS, RESULT_VALUE, SAVE_TEXT, SPECIMEN_NOTES, SPECIMEN_TYPE, STATUS, TEST_DATE, TEST_LOINC_CODE,
  TEST_NOTES, TEST_TIME
} from '../../../../constants';
