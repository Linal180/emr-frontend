...
import {
  ADD_ANOTHER_SPECIMEN, APPOINTMENT_TEXT, COLLECTION_DATE, COLLECTION_TIME, CREATE_LAB_ORDER, 
  DESCRIPTION, DIAGNOSES, EMPTY_OPTION, SAVE_TEXT, SPECIMEN_NOTES, SPECIMEN_TYPE, STATUS, 
