...
import {
  APPOINTMENT_TEXT, EMPTY_OPTION, GUARANTOR, LAB_TEST_STATUSES, N_A, PRIMARY_PROVIDER, REFERRING_PROVIDER, STATUS, TEST, TESTS_FIELD_VALIDATION_MESSAGE
} from '../../../../constants';
...
const LabOrderComponent: FC<LabOrderInitialScreenProps> = ({ appointmentInfo, setTestsToRemove }): JSX.Element => {
  ...
  const { fields: testFieldValuesFields, append: appendTestFieldValuesFields, remove: removeTestFieldValuesFields } = useFieldArray({ control: control, name: 'testFieldValues' });
