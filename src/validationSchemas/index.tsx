...
import { INVALID_EMAIL, ALPHABETS_REGEX, MaxLength, MinLength, NUMBER_REGEX, ValidMessage, PASSWORD_REGEX, PASSWORD_VALIDATION_MESSAGE, CONFIRM_YOUR_PASSWORD, PASSWORDS_MUST_MATCH, FIRST_NAME, LAST_NAME, PHONE_NUMBER, EMAIL, PASSWORD_LABEL, PASSWORD, MOBILE_NUMBER, USER_NAME, DOB, GENDER, ROLE, FACILITY } from "../constants";
