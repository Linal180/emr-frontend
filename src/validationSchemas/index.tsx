...
import {
  ...
  PAYMENT_TYPE, APPOINTMENT_PAYMENT_TYPE, LAST_FOUR_DIGIT, PROBLEM_TEXT, FAMILY_RELATIVE, RELATIVE, MANUFACTURER_TEXT, NDC_TEXT, ROUTE, SITE_TEXT, UNITS, ADMINISTRATION_DATE, UPFRONT_PAYMENT_TYPES,
} from "../constants";
...
export const createUpFrontPaymentSchema = yup.object({
  [UPFRONT_PAYMENT_TYPES.Additional]: yup.array().of(
    yup.object().shape({
      type: selectorSchema('Type is Required', true),
